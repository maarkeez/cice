...
class DMDInventarioTabla: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if(segue.identifier == "inventarioXescanerqr"){
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let celdaInventario = tableView.dequeueReusableCell(withIdentifier: "InventarioCelda", for: indexPath) as! DMDInventarioCelda
...
extension DMDInventarioTabla : DMDEscanerQRDelegate{
