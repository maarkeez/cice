...
class DMDRecbirPedidoNav: UINavigationController {
...
extension DMDRecbirPedidoNav : DMDListaRecibirPedidoDelegate{
    ...
    func setPedidoProductos(_ lista: [PedidoProductos]){
        ...
        for stock in stocks {
            StockService.shared.add(stock: stock, callback: { (stock) in
    ...
    func dismissNav() {
        print("Haciendo dismiss del nav")
        self.dismiss(animated: true, completion: nil)
    }
}

extension DMDRecbirPedidoNav : DMDConfirmDelegate{
    func confirmar(){
    ...
    func getTexto() -> String{
        return "Su pedido ha sido recepcionado correctamente"
    }
}
